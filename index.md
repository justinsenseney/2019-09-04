...
venue: "Building 101"        # brief name of host site without address (e.g., "Euphoric State University")
address: "100 Burearu Dr. Gaitherburg, MD 20899"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "39.1440,-77.2016"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Sep 4-5, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "0900 - 1500"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-09-04      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-09-05        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: Justin Senseney, etc # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: Justin's helper    # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
